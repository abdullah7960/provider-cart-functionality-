...
class ItemsSelected extends StatefulWidget {
  const ItemsSelected({super.key});

  @override
  State<ItemsSelected> createState() => _ItemsSelectedState();
}
...
class _ItemsSelectedState extends State<ItemsSelected> {
  ...
  Widget build(BuildContext context) {
    final favouriteeProvider = Provider.of<ItemsProvider>(context);
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
            ...
            Expanded(
              child: GridView.builder(
                gridDelegate:SliverGridDelegateWithFixedCrossAxisCount(
                  ...
                  shrinkWrap: true,
                  itemCount: favouriteeProvider.itemssSelected.length, 
                  itemBuilder   : (_ , index){
